...
@section('content')
        ...
        <h2 class="text-center pb-0" style=" color: #403254; font-size: 55px; font-weight: 800; line-height: 1.2em; text-weight:800; font-family: "Roboto", Sans-serif;">The Listings We’re<br>Excited About</h2>
