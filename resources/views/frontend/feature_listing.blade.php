...
<div class="elementor-element elementor-element-81c7d77 elementor-widget elementor-widget-shortcode" data-id="81c7d77" data-element_type="widget" data-widget_type="shortcode.default">
    <div class="elementor-widget-container">
        <div class="elementor-shortcode"><!-- search long -->
...
<!-- search long end --></div>
    ...
    <section class="text-center pt-5 mb-0 pb-0" style="background-color:#F1F2F9; margin-top:40px">
        <div class="container">
            <div class="row mb-5">
...
<div class="imagebg text-center height-70" style=" background: linear-gradient(rgba(58, 53, 148, 0.8), rgba(58, 53, 148, 0.8)), url('{{ asset('uploads/CTAPanel.png') }}');; background-repeat: no-repeat; background-size: cover; margin-top:40px" >
